...
a+"</strong>.</em>"},hideOnSelect:!0,label:null,minChars:1,onBlur:null,onChange:null,onError:null,onFocus:null,onMinChars:null,onNoResults:null,onRequestBefore:null,onRequestAfter:null,onResults:null,onSelect:function(a){this.val(a.title||a.name)},param:"q",required:!1,selectable:"*",selected:null,url:null,allowCustom:!1,customData:function(a){return{value:a.val()}}},keys:{DOWN:40,ENTER:13,ESC:27,UP:38},_create:function(){this.$input=this.element.addClass("mp_input");this.$list=f('<ol class="mp_list" />').hide().insertAfter(this.$input);
...
this,d=a===m,e={};d?e=c.options:e[a]=b;f.each(e,function(a,b){switch(a){case "label":c.options.label=f(b).addClass("mp_label");c._toggleLabel();break;case "selected":d&&b&&c.select(b,null);break;case "url":if(!b)c.options.url=c.$input.closest("form").attr("action")}});return c},change:function(a){a!==this.value&&(this.$input.val(a),this._change(a),this.focusPseudo?this._cancelPendingRequest()._hideAndEmptyList():this._toggleLabel())},search:function(a){var b=this.$input;a!==m&&b.val(a);b.focus()},
select:function(a,b){var c=this.$input,d=this.options.hideOnSelect;this.selected=a;d&&this._hideList();a?this._trigger("select",[a,b]):c.val("");if(c.val()!==this.value)this.value=c.val(),this.focusPseudo||this._toggleLabel(),this._hideAndEmptyList()},_initSelected:function(){var a=this.$input,b=a.data("selected"),a=a.val();b?this.select(b,null):a&&this.select(a,null);return this},destroy:function(){var a=this.options;this.$list.remove();"off"!==this.autocomplete&&this.$input.removeAttr("autocomplete");
...
f();switch(b.which){case a.keys.UP:b.preventDefault();a._showList()._highlightPrev();break;case a.keys.DOWN:b.preventDefault();a._showList()._highlightNext();break;case a.keys.ENTER:b.preventDefault();if(!c.is(":visible"))break;e=a._highlighted();e.length?a.select(e.data("marcoPolo"),e):a.options.allowCustom&&a.select(a.options.customData(a.$input));break;case a.keys.ESC:a._cancelPendingRequest()._hideList()}}).bind("keyup.marcoPolo",function(){b.val()!==a.value&&a._request(b.val())}).bind("blur.marcoPolo",
function(){a.focusReal=!1;setTimeout(function(){a.mousedown||a._dismiss()},1)});return a},_bindList:function(){var a=this;a.$list.bind("mousedown.marcoPolo",function(){a.mousedown=!0}).delegate("li.mp_selectable","mouseover",function(){a._addHighlight(f(this))}).delegate("li.mp_selectable","mouseout",function(){a._removeHighlight(f(this))}).delegate("li.mp_selectable","mouseup",function(){var b=f(this);a.select(b.data("marcoPolo"),b);a.selectedMouseup=!0;a.$input.focus()});return a},_bindDocument:function(){var a=
this;f(document).bind("mouseup.marcoPolo",a.documentMouseup=function(){a.mousedown=!1;!a.focusReal&&a.$list.is(":visible")&&a._dismiss()});return a},_toggleLabel:function(){var a=this.options.label;a.length&&(this.focusPseudo||this.$input.val()?a.hide():a.show());return this},_firstSelectableItem:function(){return this.$list.children("li.mp_selectable:visible:first")},_lastSelectableItem:function(){return this.$list.children("li.mp_selectable:visible:last")},_highlighted:function(){return this.$list.children("li.mp_highlighted")},
